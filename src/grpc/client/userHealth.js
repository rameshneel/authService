...
class UserHealthMonitor {
  ...
  initialize() {
    try {
      ...
      safeLogger.error("Failed to initialize user health monitor:", error);
    }
  }
...
function initializeUserHealth() {
  userHealthMonitor.initialize();
}
...
export { initializeUserHealth, stopMonitoring, isServiceHealthy };
